        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your one-stop destination for all your reading needs. Discover, purchase, and enjoy books across all genres.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to get updates on new releases, offers, and more!
            </p>
